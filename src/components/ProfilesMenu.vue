...
defineProps<{ names: string[]; current: string }>()
...
<template>
  <div class="pm">
    ...
    <button class="pm-btn" type="button" title="Save current layout" @click="emit('save')">Save</button>
...
.pm-btn:hover { color: var(--fg); border-color: var(--fg2); }
</style>
